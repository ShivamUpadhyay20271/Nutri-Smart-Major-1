...
function NotificationsSection() {
  ...
  const [notifications, setNotifications] = useState([{
    ...
    message: "Your donation has been accepted by an NGO. Thank you for your generousity!, check your donation history for more information.",
    date: "Today, 9:30 AM",
    read: false,
  },])
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex space-x-2 overflow-x-auto pb-2">
            <button
              ...
              className={`px-4 py-2 rounded-md whitespace-nowrap ${filter === "all" ? "bg-green-500 text-white" : "bg-gray-100 hover:bg-gray-200"
                }`}
            >
              All
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-md whitespace-nowrap ${filter === "unread" ? "bg-green-500 text-white" : "bg-gray-100 hover:bg-gray-200"
                }`}
            >
              Unread
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-md whitespace-nowrap ${filter === "donation" ? "bg-green-500 text-white" : "bg-gray-100 hover:bg-gray-200"
                }`}
            >
              Donations
            </button>
